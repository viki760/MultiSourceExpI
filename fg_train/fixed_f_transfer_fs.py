...
from fg_train.fixed_f import fg, Net_f, Net_g


class transfer_fg_fs(fg):

    '''
    calculation with fixed feature extractor with transfer, few-shot
    '''

    def __init__(self, cfg, t_ids, s_ids, alpha):
        
        super(transfer_fg_fs, self).__init__(cfg=cfg, t_id=t_ids)  

        self.data_path = "data/data_set_1/"
