...
# id = sys.argv[1]
def empirical_fg_transfer(t_id, s_id, alpha, batch_size=10, num_epochs=20, lr=0.0001):
    train_loader_s = load_data(s_id, batch_size, 0)
    train_loader_t = load_data(t_id, batch_size, 0)
